                  ...
                  <div class="col-md-8 col-sm-8">
                     <div class="right_bottun">
                        <ul class="conat_info d_none ">
                           <li><a href="{{ url('/register') }}"><i class="fa fa-user" aria-hidden="true"></i></a></li>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12 col-lg-7">
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="ban_track">
                                       <figure><img src="{{ asset('images/track.png') }}" alt="#"/></figure>
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                                    <form class="transfot">
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="service_main">
                     ...
                     <div class="service_box yelldark_colo">
                        <i><img src="{{ asset('images/ser4.png') }}" alt="#"/></i>
                        <h4>BOX STORAGE</h4>
                     </div>
                     <div class="service_box yell_colo">
                        <i><img src="{{ asset('images/ser5.png') }}" alt="#"/></i>
                        <h4>100% safe</h4>
                     </div>
                  </div>
               </div>
                        ...
                        <div class="row">
                           <div class="col-md-4">
                              <div class="vehicles_truck">
                                 <figure><img src="{{ asset('images/truc1.png') }}" alt="#"/></figure>
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="vehicles_truck">
                                 <figure><img src="{{ asset('images/truc2.png') }}" alt="#"/></figure>
                              </div>
                              <h3 class="blac_co">Truck</h3>
                           </div>
                           <div class="col-md-4">
                              <div class="vehicles_truck">
                                 <figure><img src="{{ asset('images/truc3.png') }}" alt="#"/></figure>
                              </div>
                           </div>
                        </div>
                     </div>
         ...
         <div class="con_bg">
            <div class="container-fluid">
               <div class="row">
                  ...
                  <div class="col-md-7">
                     <div class="co_tru">
                        <figure><img src="{{ asset('images/truc4.png') }}" alt="#"/></figure>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="footer bottom_cross1">
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <p>© 2024 Todos los derechos reservados. Diseñado por <a href="https://github.com/Maxyris"> Maxyris</a></p>
                     </div>
                  </div>
               </div>
            </div>
